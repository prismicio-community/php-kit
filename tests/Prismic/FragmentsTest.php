...
class FragmentsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSlices()
    {
        ...
        $this->assertEquals($slices->asText(), "https://wroomdev.s3.amazonaws.com/toto/db3775edb44f9818c54baa72bbfc8d3d6394b6ef_hsf_evilsquall.jpgc'est un bloc featuresC'est un bloc content");
